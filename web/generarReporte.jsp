                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                 <form role="form" action="Reportes/reporteInfoCaso.jsp"  method="POST" >
                              <div  class="form-group">

                                        <label for="" ><fmt:message key="label.rdepto"/></label>
                                        <div class="input-group">
                                            <input   class="form-control" readonly="true" value="${loginB.departamento}" name="n" id="n" >
                                        </div> 
                                    ...
                                    <div  class="form-group">
                                        ...
                                        <div  class="form-group">
                                            ...
                                            <label for="" ><span class="fas fa-asterisk" ></span><fmt:message key="label.rfecha1"/></label>
                                            <div class="input-group">
                                        ...
                                        <div  class="form-group">
                                            ...
                                            <label for="" ><span class="fas fa-asterisk" ></span><fmt:message key="label.rfecha2"/></label>
                                            <div class="input-group">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                 <form role="form" action="Reportes/Reporte.jsp"  method="POST" >
                                <div  class="form-group">
